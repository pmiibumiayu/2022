        ...
        <div class="card text-center">
            <div class="card-body">
                ...
                if (strlen($input) == 0) {
                    ...
                    if ($key['input'] == $data['setting']['key']['access']) {
                        shuffle($pembaca);
                    ...
                    <div class="d-grid gap-2">
                        <div class="card shadow-lg bg-warning">
                            <div class="card-body">
                                ...
                                <div class="float-end">
                                    <?= $daruser['done'] ? '<span class="btn badge rounded-pill bg-success">&#10004</span>' : '<a class="btn badge rounded-pill bg-danger" href="done.php?id=' . $daruser['id'] . '" role="button">&#10004</a>'; ?>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="col kartu">
        <div class="card">
            <div class="card-body text-center">
                <a href='reset.php' class='btn btn-warning' tabindex='-1' role='button'>Reset</a>
